...
struct Constants {
    static let MENUBAR_WIDTH: CGFloat = 330
    static let MENUBAR_HEIGHT: CGFloat = 402
    static let CONTENT_WIDTH: CGFloat = 320
    ...
    static let TUTORIAL_WIDTH: CGFloat = 300
    static let TUTORIAL_HEIGHT: CGFloat = 200
}
